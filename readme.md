...
## TDD Resful With Laravel Intelisys Prensentation
...
### Laravel
Es un framework de código abierto para desarrollar aplicaciones y servicios web con PHP 5 y PHP 7. Su filosofía es desarrollar código PHP de forma elegante y simple, evitando el "código espagueti". Fue creado en 2011 y tiene una gran influencia de frameworks como Ruby on Rails, Sinatra y ASP.NET MVC


- [Presentation](https://docs.google.com/presentation/d/1v8ZnSVhR0YiTtSWAB2VofKsluH5PL-c0NToY_y8zPtk/edit#slide=id.g5e55b4e962_0_23).

## Run the test
- all the test are on the tests folder
- On the console run `compose test`


## Contributing

Thank you all of the team of Soul Cycle in DR.
